...
//Routers
app.use('/sales',require('./Routes/SalesRoutes')) //Sales Router 
app.use('/purchase',require('./Routes/PurchaseRoutes')) //Purchase Router
app.use('/collection',require('./Routes/CollectionRoutes')) //Collection Router
